...
file(GLOB mpi_bins LIST_DIRECTORIES false "${INSTALL_DIR}/intel64/bin/thread/*")
install(PROGRAMS ${mpi_bins}
        DESTINATION ${NGRAPH_INSTALL_BIN})
#install mpi tunning data
file(GLOB mpi_tun LIST_DIRECTORIES false "${INSTALL_DIR}/intel64/etc/*")
install(FILES ${mpi_tun}
